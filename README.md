...
boutique.html            Boutique (articles placeholder)
...
|---|---|---|
| `categories`, `honours`, `timeline_events`, `shop_products` | publique (si `is_published`) | admin |
...
- **Catégories / Palmarès / Histoire / Boutique** — édition en tableau, ajout et suppression
...
- Rendu desktop (1440 px) et mobile (390 px) sur les 8 pages publiques + le back-office.
